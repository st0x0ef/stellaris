...
public class FeaturesProvider extends DatapackBuiltinEntriesProvider {
    ...
    public FeaturesProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
        super(output, registries, BUILDER, Collections.singleton(Stellaris.MODID));
    }
}
