...
public class WaterSeperatorScreen extends AbstractContainerScreen<WaterSeparatorMenu> {
    ...
    private void renderWaterGauge() {
        ...
        WaterSeparatorBlockEntity.FluidTank waterTank = this.getMenu().getBlockEntity().getIngredientTank();
    ...
    private void renderHydrogenGauge() {
        ...
        WaterSeparatorBlockEntity.FluidTank hydrogenTank = this.getMenu().getBlockEntity().getResultTanks().getFirst();
