...
public record SkyObject(String texture, boolean blend, float size, Vec3 rotation, String rotationType) {
    public static final Codec<SkyObject> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            Codec.STRING.fieldOf("texture").forGetter(SkyObject::texture),
