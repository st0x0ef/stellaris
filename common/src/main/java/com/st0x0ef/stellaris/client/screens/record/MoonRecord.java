...
public record MoonRecord(
        ...
        float height, String parent, ResourceKey<Level> dimensionId, String translatable, String id, Optional<Boolean> clickable, Optional<Boolean> spaceStation, Optional<Boolean> canLaunchOn) {
    ...
    public static final Codec<MoonRecord> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            Codec.BOOL.optionalFieldOf("can_launch_on").forGetter(MoonRecord::canLaunchOn)
