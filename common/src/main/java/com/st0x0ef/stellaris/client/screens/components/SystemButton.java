...
public class SystemButton extends TexturedButton{
    ...
    public SystemButton(int xIn, int yIn, int row, int widthIn, int heightIn, int xTexStartIn, int yTexStartIn, int yDiffTextIn, boolean rocketCondition, ButtonTypes type, List<String> list, ResourceLocation buttonTexture, ColorTypes colorType, int textureWidth, int textureHeight, OnPress onPressIn, Component title) {
    ...
    public SystemButton(int xIn, int yIn, int row, int widthIn, int heightIn, int xTexStart, int yTexStart, int p_i244513_7_, boolean rocketCondition, ButtonTypes type, List<String> list, ResourceLocation buttonTexture, ColorTypes colorType, int textureWidth, int textureHeight, OnPress p_i244513_11_, CreateNarration p_i244513_12_, Component p_i244513_13_) {
