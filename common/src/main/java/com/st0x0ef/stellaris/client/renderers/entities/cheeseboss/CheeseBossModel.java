...
public class CheeseBossModel<T extends CheeseBoss> extends HierarchicalModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Stellaris.MODID, "cheese_boss"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
		CheeseBoss.render(poseStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
	}
}