...
public class ItemsRegistry {
    ...
    public static final RegistrySupplier<Item> MOON_BERRIES = ITEMS.register("glow_berries", () -> new ItemNameBlockItem(BlocksRegistry.MOON_VINES.get(), (new Item.Properties()).food(Foods.GLOW_BERRIES)));
