...
public class FuelRefineryCategory implements DisplayCategory<BasicDisplay> {
    ...
    public static final CategoryIdentifier<FuelRefineryDisplay> FUEL_REFINERY_CRAFTING = CategoryIdentifier.of(Stellaris.MODID,"fuel_refinery");

    @Override
    public CategoryIdentifier<? extends BasicDisplay> getCategoryIdentifier() {
        return FUEL_REFINERY_CRAFTING;
    }

    @Override
    public Component getTitle() {
        return Component.translatable("stellaris.compat.fuel_refinery");
    }

    @Override
    public Renderer getIcon() {
        return EntryStacks.of(BlocksRegistry.FUEL_REFINERY.get().asItem().getDefaultInstance());
    }
