...
public class MenuTypesRegistry {
    ...
    public static final RegistrySupplier<MenuType<CoalGeneratorMenu>> COAL_GENERATOR_MENU = MENU_TYPE.register("solar_panel", () -> MenuRegistry.ofExtended(CoalGeneratorMenu::create));
