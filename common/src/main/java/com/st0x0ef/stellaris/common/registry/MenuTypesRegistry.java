...
public class MenuTypesRegistry {
    ...
    public static final RegistrySupplier<MenuType<OxygenPropagatorMenu>> OXYGEN_PROPAGATOR = MENU_TYPE.register("oxygen_propagator", () -> MenuRegistry.ofExtended(OxygenPropagatorMenu::new));
