...
public class OxygenTankItem extends Item implements FluidProvider.ITEM {
    ...
    public void appendHoverText(ItemStack itemStack, TooltipContext tooltipContext, TooltipDisplay tooltipDisplay, Consumer<Component> consumer, TooltipFlag tooltipFlag) {
        consumer.accept(Component.translatable("tooltip.item.stellaris.oxygen_tank", getFluidTank(itemStack).getFluidInTank(0).getAmount(), getFluidTank(itemStack).getTankCapacity(0)).withStyle(ChatFormatting.GRAY));
    }
