...
public record RocketComponent(String skin, RocketModel model, int maxPlayer, String fuelType, int fuel, ResourceLocation fuelTexture, int tankCapacity) implements Serializable {
    ...
    public static final Codec<RocketComponent> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            Codec.INT.fieldOf("max_player").forGetter(RocketComponent::tankCapacity),
