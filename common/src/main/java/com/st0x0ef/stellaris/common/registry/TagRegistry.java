...
public class TagRegistry {
    ...
    public static final TagKey<Item> INCORRECT_FOR_STEEL_TOOL = TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath(Stellaris.MODID, "steel_tools"));
