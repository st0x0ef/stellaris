...
public class TagRegistry {
    ...
    public static final TagKey<Biome> ORBIT_BIOMES_TAG = TagKey.create(Registries.BIOME, ResourceLocationUtils.id("orbit_biomes"));
    ...
    public static final TagKey<Item> FUEL = TagKey.create(Registries.ITEM, ResourceLocationUtils.ctag("fuels"));
    ...
    public static final TagKey<Block> ANTENNA_REPLACEABLES = TagKey.create(Registries.BLOCK, ResourceLocationUtils.id("antenna_replaceable"));
    ...
    public static final TagKey<Block> ALIEN_CROPS = TagKey.create(Registries.BLOCK, ResourceLocationUtils.id("alien_crops"));
