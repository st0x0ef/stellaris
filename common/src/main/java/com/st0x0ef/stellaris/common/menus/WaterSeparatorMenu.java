...
public class WaterSeparatorMenu extends BaseContainer {
    ...
    public WaterSeparatorMenu(int containerId, Inventory inventory, Container container, WaterSeparatorBlockEntity blockEntity) {
        ...
        addSlot(new SpecificFluidContainerSlot(container, FluidRegistry.HYDROGEN_STILL.get(), 2, 20, 114, false, true)); // Hydrogen tank output
        addSlot(new SpecificFluidContainerSlot(container, FluidRegistry.OXYGEN_STILL.get(), 3, 140, 114, false, true)); // Oxygen tank output
    }
