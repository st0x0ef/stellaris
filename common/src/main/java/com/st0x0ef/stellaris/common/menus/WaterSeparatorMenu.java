...
public class WaterSeparatorMenu extends BaseContainer {
    ...
    public WaterSeparatorMenu(int containerId, Inventory inventory, Container container, WaterSeparatorBlockEntity blockEntity) {
        ...
        addSlot(new SpecificFluidContainerSlot(container, Fluids.WATER, 1, 56, 114, false, false)); // Water tank input
        addSlot(new SpecificFluidContainerSlot(container, FluidRegistry.FLOWING_HYDROGEN.get(), 2, 20, 114, false, true)); // Hydrogen tank output
        addSlot(new SpecificFluidContainerSlot(container, FluidRegistry.FLOWING_OXYGEN.get(), 3, 140, 114, false, true)); // Oxygen tank output
    }
